...
import com.leetcode.medium.graph.dfs.CloneGraph;
...
public class CloneGraphTest {
    ...
    public void cloneGraphTestOfNode1() {
        ...
        ArrayList<CloneGraphNode> _neighborsOf1 = new ArrayList<>();
    ...
    public void cloneGraphTestOfNode2() {
        ArrayList<CloneGraphNode> _neighborsOf2 = new ArrayList<>();
